...
const TrendingSongList = ({isLogged}) => {
    ...
    <div className="p-4 bg-gray-900">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-2 sm:mb-0">
          <h2 className="text-2xl font-bold text-white">Trending Music</h2>
        ...
        <div>
        <SpecialBtn btnTxt="See More" link={isLogged ? `/${username}/category/${activeCategory}` : `/category/${activeCategory}`} />
        </div>
      </div>
