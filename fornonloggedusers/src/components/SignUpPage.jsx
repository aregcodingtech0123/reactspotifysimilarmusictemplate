...
const SignUpPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Here you would handle the signup request to your API
    console.log('Sign up data:', formData);
    alert('Kayıt bilgileri: ' + formData.email);
  };
        ...
        <div className="p-6">
          <form onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-green-500 transition duration-150"
              >
                Sign Up
              </button>
            </div>
