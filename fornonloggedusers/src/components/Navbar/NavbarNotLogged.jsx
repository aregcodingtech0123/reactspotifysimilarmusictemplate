    ...
    <nav className="bg-gray-800 shadow-md px-2 sm:px-4 py-3 sticky top-0 z-10">
      <div className="container mx-auto flex flex-wrap justify-between items-center ">
        ...
        <div className={`${isMenuOpen ? 'flex' : 'hidden'} md:flex flex-col md:flex-row w-full md:w-auto md:items-center gap-4 md:gap-6 mt-4 md:mt-0`}>
          ...
          <a href="/" className="text-white hover:text-indigo-600 transition py-2 md:py-0">Home</a>
          <a href="/about" className="text-white hover:text-indigo-600 transition py-2 md:py-0">About</a>
          
          <div className="flex flex-col md:flex-row gap-2 md:gap-4">
            <Link
              to="/login" // /login sayfasına yönlendir
            ...
            {/* Sign up butonu */}
            <Link
              to="/signup" // /signup sayfasına yönlendir
